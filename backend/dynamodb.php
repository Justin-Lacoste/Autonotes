...
$subject_color = $_GET["subject_color"];
$time = $_GET["time"];
$date = $_GET["date"];
$day = $_GET["day"];
$month = $_GET["month"];
$s3_title = $_GET["s3_title"];
$token = $_GET["token"];
...
$entityBody = '{"TableName": "autonotesone", "Key": {"users": {"S": "' . $email . '"}}, "UpdateExpression": "SET classes = list_append(if_not_exists(classes, :empty_list), :my_value)", "ExpressionAttributeValues": {":my_value": {"L": [{"M": {"title":{"S": "'. $title. '"}, "subject_id":{"S": "'. $subject_id. '"}, "subject":{"S": "'. $subject. '"}, "subject_color":{"S": "'. $subject_color. '"}, "time":{"S": "'. $time. '"}, "date":{"S": "'. $date. '"}, "day":{"S": "'. $day. '"}, "month":{"S": "'. $month. '"}, "s3_title":{"S": "'. $s3_title. '"}}}]},":empty_list": {"L": []}}}';

...
$entityBody = '{"TableName": "autonotesone", "Key": {"users": {"S": "' . $email . '"}}, "UpdateExpression": "SET clock = :my_value", "ExpressionAttributeValues": {":my_value": {"S": "'. $clock. '"}}}';

//$entityBody = '{"TableName": "autonotesone", "Key": {"users": {"S": "' . $email . '"}}, "UpdateExpression": "SET clock = :my_value", "ConditionExpression": ("token IN (:cat1))", "ExpressionAttributeValues": {":my_value": {"S": "'. $clock. '"}, ":cat1": {"S": "'. $token. '"}}}';
//$entityBody = '{"TableName": "autonotesone", "Key": {"users": {"S": "' . $email . '"}}, "UpdateExpression": "SET clock = :my_value", "ExpressionAttributeValues": {":my_value": {"S": "'. $clock. '"}}}';
